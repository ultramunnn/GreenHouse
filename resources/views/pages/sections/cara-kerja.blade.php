...
<section id="cara-kerja" class="py-20 bg-white mt-2 p-5">
    <div class="container mx-auto px-3">
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">Sistem greenhouse kami dirancang untuk memudahkan pemantauan dan perawatan tanaman dengan teknologi terkini yang minim intervensi manual.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 py-10">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow text-center">
                ...
                <p class="text-gray-600">PPantau kesehatan dan pertumbuhan tanaman Anda dengan aplikasi kami, yang memberikan data dan analisis langsung untuk kemudahan kontrol jarak jauh.</p>
            </div>
        </div>
    </div>
</section> 